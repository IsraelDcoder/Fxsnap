...
export default function AnalysisResultScreen() {
  ...
  const handleShare = async () => {
    ...
    if (Platform.OS === 'web' || !shareCardRef.current) {
      await handleCopy();
      showToast('Signal copied to clipboard for sharing');
      return;
    }
    ...
    try {
      ...
      await handleCopy();
      showToast('Could not create image. Signal copied instead.');
    } finally {
  ...
  const handleCopy = async () => {
    ...
    const dir = currentAnalysis.direction === 'BUY' ? 'BUY ↑' : 'SELL ↓';
    const text = [
      `🎯 FXSnap Signal`,
      ``,
      ...
      `Stop Loss:   ${currentAnalysis.sl}`,
      `Take Profit: ${currentAnalysis.tp}`,
      `Lot Size:    ${currentAnalysis.lotSize > 0 ? currentAnalysis.lotSize.toFixed(2) : 'Below broker minimum / unavailable'}`,
      `SL Distance: ${currentAnalysis.slPips} pips`,
      ``,
      `Generated by FXSnap`,
    ].join('\n');
    ...
    <View style={[styles.container, { paddingTop: topPad, backgroundColor: colors.background }]}>
      ...
      >
        ...
        >
          ...
          <Animated.View entering={FadeInDown.delay(350).duration(500)}>
            <View style={styles.confidenceRow}>
              <Text style={[styles.confidenceLabel, { color: colors.textSecondary }]}>Composite score</Text>
        ...
        <Animated.View entering={FadeInUp.delay(900).duration(500)} style={styles.levelsCard}>
          ...
          <DataRow label="Lot Size" value={currentAnalysis.lotSize > 0 ? currentAnalysis.lotSize.toFixed(2) : 'Below broker minimum'} delay={950} />
          <View style={styles.divider} />
          <DataRow label="SL Distance" value={`${currentAnalysis.slPips} pips`} delay={1050} />
          <View style={styles.divider} />
        ...
        <Animated.View entering={FadeInUp.delay(1350).duration(500)} style={styles.actions}>
          ...
          <TouchableOpacity style={styles.copyBtn} onPress={handleCopy}>
            ...
            <Text style={styles.copyBtnText}>Copy Signal</Text>
          </TouchableOpacity>
          ...
          >
            ...
            <Text style={styles.copyBtnText}>Share Signal</Text>
          </TouchableOpacity>
          ...
          <View style={styles.actionRow}>
            ...
            <TouchableOpacity style={[styles.newBtn, !alreadySaved && { flex: 1 }, alreadySaved && { flex: 1 }]} onPress={() => {
              Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
      ...
      <View ref={shareCardRef} collapsable={false} style={styles.hiddenShareContainer}>
        <View style={[styles.shareCard, { backgroundColor: colors.card, borderColor: colors.cardBorder }]}>
          <View style={styles.shareHeaderRow}>
            ...
            <View style={[styles.shareDirectionBadge, { backgroundColor: isBuy ? '#023315' : '#3F0A0A' }]}> 
              <Text style={[styles.shareDirectionText, { color: directionColor }]}>{currentAnalysis.direction}</Text>
            </View>
          </View>
          ...
          <View style={styles.shareFooter}>
            <Text style={[styles.shareFooterText, { color: colors.textSecondary }]}>Share this signal with your trading crew</Text>
...
const styles = StyleSheet.create({
  ...
  directionText: { fontSize: 20, fontFamily: 'Inter_700Bold', letterSpacing: 1 },
  ...
  dataValue: { fontSize: 17, fontFamily: 'Inter_600SemiBold', color: '#FFFFFF' },
